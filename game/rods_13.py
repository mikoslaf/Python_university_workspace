...
def find_rods_of_length_13(blues: list[float], reds: list[float]) -> float: # Glupi kod
    """
...
def find_rods_of_length_13_bsearch(blues: list[float], reds: list[float]) -> float: # Z binary searchem
    """
    Trzeba wybrać jeden element z blues i jeden z reds tak by suma długości tych elementów była jak najbliższa 13.
    :param blues:
    :param reds:
